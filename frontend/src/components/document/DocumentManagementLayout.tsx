...
const menuItems = [
  {
    title: 'Dashboard',
    description: 'View document management overview and metrics',
    icon: <DashboardIcon />,
    path: '/document-management',
  },
  {
    title: 'Document Library',
    description: 'Browse and manage all your official documents',
    icon: <DocumentIcon />,
    path: '/document-management/library',
  },
  {
    title: 'Records',
    description: 'View and manage all submitted and approved forms',
    icon: <RecordsIcon />,
    path: '/document-management/records',
  },
  {
    title: 'Change Requests',
    description: 'Manage document change requests',
    icon: <ChangeRequestIcon />,
    path: '/document-management/change-request-management',
  },
  {
    title: 'Approval Workflow',
    description: 'Manage document and form approval processes',
    icon: <ApprovalIcon />,
    path: '/document-management/approvals',
  },
  {
          ...
          <Toolbar sx={{ justifyContent: 'space-between', px: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box>
                ...
                >
                  {menuItems.find(item => item.path === location.pathname)?.title || 'Document Management'}
                </Typography>
                <Typography
                  variant="caption"
                  sx={{
