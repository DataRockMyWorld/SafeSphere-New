...
from .views import (
    LoginUserView, LogoutUserView, UserMeView, PasswordResetRequestView, PasswordResetConfirmView,
...
urlpatterns = [
    ...
    path('me/', UserMeView.as_view(), name='user-me'),  # Changed from 'me' to 'user-me'
    ...
    path('notifications/mark-all-read/', MarkAllNotificationsReadView.as_view(), name='mark-all-read'),  # Changed from 'mark-all-notifications-read'
